...
const allowProct = document.getElementById('allow_proct');
const container = document.getElementById('container');
const count = document.getElementById('count');
const chatScroll = document.getElementById('chat-scroll');
const chatContent = document.getElementById('chat-content');
const chatInput = document.getElementById('chat-input');
const offVideo = document.getElementById('off_video');
const onVideo = document.getElementById('on_video');
...
function connectButtonHandler(event) {
    ...
    if (!connected) {
        ...
        connect(username).then(() => {
            ...
            allowProct.disabled = false;
            offVideo.disabled = false;
        }).catch(() => {
...
function offVideoHandler() {
    event.preventDefault();
    let disabler = document.querySelector("#off_video"); 
...
chatInput.addEventListener('keyup', onChatInputKey);
 onVideo.addEventListener('click', onVideoHandler);
